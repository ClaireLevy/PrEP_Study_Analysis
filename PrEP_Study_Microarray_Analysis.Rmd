...
pander(camera_function(duod_expressed, Hs.H) %>%
  select(-FDR)%>%
  head(n = 10))
```
...
#I want to use the "Hs.H" hallmark genesets
pander(camera_function(rec_expressed, Hs.H) %>%
  select(-FDR)%>%
  head(n = 10))
```
...
#I want to use the "Hs.H" hallmark genesets
pander(camera_function(pb_expressed, Hs.H) %>%
  select(-FDR)%>%
  head(n = 10))
```
...
#I want to use the "Hs.H" hallmark genesets
pander(camera_function(px_expressed, Hs.H) %>%
  select(-FDR)%>%
  head(n = 10))
```
...
pander(camera_function(duod_expressed, Hs.c5.BP) %>%
  select(-FDR)%>%
  head(n = 10))
```
...
#I want to use the "Hs.c5.BP"  genesets
pander(camera_function(rec_expressed, Hs.c5.BP) %>%
  select(-FDR)%>%
  head(n = 10))
```
...
#I want to use the "Hs.c5.BP"  genesets
pander(camera_function(pb_expressed, Hs.c5.BP) %>%
  select(-FDR)%>%
  head(n = 10))
```
...
#I want to use the "Hs.c5.BP" genesets
pander(camera_function(px_expressed, Hs.c5.BP) %>%
  select(-FDR)%>%
  head(n = 10))
```
...
pander(camera_function(duod_expressed, mtn_007_sets) %>%
  select(-FDR))
```
...
#I want to use the "mtn_007_sets"  genesets
pander(camera_function(rec_expressed, mtn_007_sets) %>%
  select(-FDR))
```
...
#I want to use the "mtn_007_sets"  genesets
pander(camera_function(pb_expressed, mtn_007_sets) %>%
  select(-FDR))
```
...
#I want to use the "mtn_007_sets"  genesets
pander(camera_function(px_expressed, mtn_007_sets) %>%
  select(-FDR))
```
